...
export const Cart = () => {
  ...
  const deletecart = (product) => {
    cartData.splice(
      cartData.findIndex((pi) => pi.id === product.id),
      1
    );
                ...
                return (
                  <div className="prod">
                    ...
                    <div className="data">
                      ...
                      <IconButton
                        onClick={() => deletecart(prod)}
                        style={{ marginLeft: "450px", marginTop: "-250px" }}
                        aria-label="delete"
                      >
                        <DeleteIcon />
                      </IconButton>
            ...
            <div className="summary">
              ...
              <div className="rows">
                ...
                <p id="sum">
                  {" "}
                  {c}{" "}
                  <small className="sm-text">(Inclusive of all taxes)</small>
                </p>
              </div>
