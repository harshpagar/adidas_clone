    ...
    <div className="nav">
      ...
      <div>
        <input
          ...
          type="search"
          placeholder=" Search"
          onChange={(e) => props.searchd(e.target.value)}
        />
      </div>
