  ...
  const fetchData = async () => {
    try {
      ...
      const fetchdata = await fetch(
        "https://adidas11.herokuapp.com/products"
      ).then((res) => res.json());
      ...
      <div>
        ...
        <div className="flex">
          <div className="sortingdiv">
            <span id="spanbutton2">
              <Button
                onClick={() => catfilter("Mens")}
                style={{
                  backgroundColor: "rgb(59, 198, 198)",
                  borderRadius: "15px",
                  marginTop: "15px",
                  width: "140px",
                }}
              ...
              {todos
                .filter((ele) => {
                  if (searchdata === "" || searchdata === undefined) {
                    ...
                    return ele.Title.toLowerCase().includes(
